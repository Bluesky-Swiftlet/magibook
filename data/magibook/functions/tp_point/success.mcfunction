...
setblock ~ ~1 ~ minecraft:birch_wall_sign{Text1: '{"text":"Owner: ","extra":[{"selector":"@p"}],"color":"dark_purple","italic": false,"bold": true}'}
data modify entity @e[tag=teleport_point,sort=nearest,limit=1] CustomName set from block ~ ~1 ~ Text1
setblock ~ ~1 ~ air
